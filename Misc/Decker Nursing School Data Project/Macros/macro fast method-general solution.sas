libname xMacros "D:\My Documents\My Projects\Decker Nursing School Data Project\Macros";
*option mstored sasmstore=xMacros;
/*
...
option NOMLOGIC, NOMLOGICNEST, NOMPRINT, NOMPRINTNEST, NOSYMBOLGEN ;
...
*libname xdata2 "D:\My Documents\My Projects\Decker Nursing School Data Project\Macros";
/*
libname xdata "D:\My Documents\My Projects\Decker Nursing School Data Project";
%let time0=%sysfunc(time());
%let IDvar=RECTYPE;
%let IDvalue=H;
%let longds=xdata.pums_ak;
%let wideds=xdata.wide_ak;

%count_P(&longds, &IDvar, &IDvalue);
...
%getname(xdata.varh);
%longtowide(&longds, &wideds, &IDvar, &IDvalue, &hvar_low, &hvar_hi, &pid_low, &pid_hi, &pvar_low, &pvar_hi);
